...
class Exam(models.Model):
    ...
    # Métadonnées
    created_by = models.ForeignKey('home_auth.CustomUser', on_delete=models.SET_NULL, null=True, verbose_name="Créé par")
    created_at = models.DateTimeField(auto_now_add=True)
...
class ExamResult(models.Model):
    ...
    graded_by = models.ForeignKey('home_auth.CustomUser', on_delete=models.SET_NULL, null=True, blank=True, verbose_name="Noté par")
